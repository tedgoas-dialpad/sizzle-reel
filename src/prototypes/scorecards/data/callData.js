...
export const playbackSegments = [
  { color: '#7C52FF', width: 32 },
  { color: '#52C926', width: 8 },
  { color: '#7C52FF', width: 20 },
  { color: '#EC0E0E', width: 5 },
  { color: '#7C52FF', width: 15 },
  { color: '#52C926', width: 4 },
  { color: '#7C52FF', width: 12 },
  { color: '#FFB020', width: 4 },
]
